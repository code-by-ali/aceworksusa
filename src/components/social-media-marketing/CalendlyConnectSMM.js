          ...
          <div className="flex flex-col justify-center text-white space-y-8 px-4 lg:px-8">
            <div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-4">
                Rated 4.9 Out of 5 by 500+ Business Owners Who Needed Real
                Social Results
              </h1>
            </div>

            <p className="text-lg md:text-xl text-white leading-relaxed">
              Join hundreds of businesses that stopped wasting time posting
              without a strategy. Our best social media marketing agency
              approach focuses on what matters: engagement that converts, ads
              that perform, and content that actually grows your business.
            </p>
...
export default CalendlyConnectSMM;
