          ...
          <div className="flex flex-col justify-center text-white space-y-8 px-4 lg:px-8">
            <div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-4">
                Rated 4.9 Out of 5 by 500+ Business Owners Who Needed Profitable
                PPC Campaigns
              </h1>
            </div>

            <p className="text-lg md:text-xl text-white leading-relaxed">
              Join hundreds of businesses who stopped flushing money down the
              Google Ads drain. Our best PPC agency approach focuses on metrics
              that matter: qualified leads, customer acquisition cost and
              profitable return, not just clicks and impressions.
            </p>
...
export default CalendlyConnectPPCA;
