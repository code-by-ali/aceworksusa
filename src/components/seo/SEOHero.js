    ...
    <section className="w-full flex flex-col lg:flex-row items-center justify-between px-6 lg:px-20 py-16 bg-white gap-10">
      ...
      <div className="flex-1 space-y-6 text-center lg:text-left">
        ...
        <h1 className="text-3xl md:text-4xl lg:text-6xl font-semibold leading-tight text-primary tracking-tight">
          SEO Optimization That Turns Search Traffic Into Paying Customers
        </h1>

        <p className="text-[#525866] text-base md:text-lg font-medium leading-relaxed mx-auto lg:mx-0">
          Acework's SEO optimization service is designed to dominate search
          results and turn your website into a customer-generating machine. As a
          leading SEO agency USA businesses trust, we combine technical
          expertise with proven strategies that deliver measurable growth.
        </p>
